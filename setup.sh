...
if [[ $INST == "Y" || $INST == "y" ]]; then
    ...
    hypr_pkgs="hyprland-git hyprpicker-git hypridle-git hyprlock-git"    
    font_pkgs="eza ttf-nerd-fonts-symbols-common otf-firamono-nerd inter-font otf-sora ttf-fantasque-nerd noto-fonts noto-fonts-emoji ttf-comfortaa"
    font_pkgs2="ttf-jetbrains-mono-nerd ttf-icomoon-feather ttf-iosevka-nerd adobe-source-code-pro-fonts ttf-firacode-nerd"
    app_pkgs="brightnessctl dunst swww-git kitty wl-clipboard wf-recorder rofi-wayland rofi-emoji wlogout python-requests gowall libreoffice-fresh"
    app_pkgs2="ungoogled-chromium-bin catppuccin-cursors-mocha catppuccin-gtk-theme-mocha-revamped papirus-folders-catppuccin-git nwg-look qt5ct btop jq gvfs ffmpegthumbs mousepad mpv playerctl pamixer noise-suppression-for-voice xarchiver wttr kvantum-qt5 qt6ct"
    app_pkgs3="polkit-gnome ffmpeg neovim viewnior pavucontrol thunar ffmpegthumbnailer tumbler thunar-archive-plugin xdg-user-dirs zsh-autosuggestions zsh-history-substring-search zsh-syntax-highlighting zsh-theme-powerlevel10k-git"
